...
<%
        ...
        String s=request.getParameter("Prod_id");
        String s1=request.getParameter("Prod_name");
        String s2=request.getParameter("Price");
        String s3=request.getParameter("Prod_size");
        String s4=request.getParameter("Prod_cat");
		String s5=request.getParameter("Prod_info");
		String s6=request.getParameter("Prod_image");
      ...
      if (conn != null) {
         ...
         Statement st=conn.createStatement();
		   ...
		   ps.setString(7,s6);
		    ...
		    {
				out.println("Sorry Not Added ! Error !");
			}
           ps.close (); 
		   conn.close ();
        ...
        %>
        <br><hr>
               To View Products <a href="employeeview.jsp">Click Here</a>
                <hr>
</body>
</html>